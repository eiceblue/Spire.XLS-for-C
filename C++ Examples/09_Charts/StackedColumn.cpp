...
int main() {
	...
	dynamic_pointer_cast<CellRange>(sheet->GetRange(L"A1:C1"))->GetStyle()->SetColor(Spire::Xls::Color::GetDarkGray());
	dynamic_pointer_cast<CellRange>(sheet->GetRange(L"A1:C1"))->GetStyle()->GetFont()->SetColor(Spire::Xls::Color::GetWhite());
